...
set ProjectDIR=D:\Ray\MyProject\GitHub\ray20200720\ITHelp\SampleCode\ASP.NET\C#\Interface
...
ECHO -----------------------------------------------          
ECHO ***********************************************
ECHO ***    build Interface Starting   ****
ECHO ***********************************************
ECHO -----------------------------------------------

REM step2 clear old bin; build solution
REM %FrameworkDIR%\v4.0.30319\csc.exe ConsoleHost.cs
%FrameworkDIR%\v4.0.30319\csc.exe %ProjectDIR%\InterfaceDemo.cs
